...
architecture arch of nios_model is
    ...
    constant operations : operations_t := (
        (cmd => READ,  addr => 16x"EEEE", data => x"33" ),
        (cmd => READ,  addr => 16x"7C", data => (others => '1') ),
        (cmd => WRITE, addr => 16x"27", data => 8x"42" ),
        (cmd => READ,  addr => 16x"27", data => 8x"42" ),
        (cmd => WRITE, addr => 16x"90", data => 8x"10" ),
        (cmd => WRITE, addr => 16x"91", data => 8x"11" ),
        (cmd => WRITE, addr => 16x"92", data => 8x"12" ),
        (cmd => WRITE, addr => 16x"93", data => 8x"13" ),
        (cmd => WRITE, addr => 16x"A0", data => 8x"20" ),
        (cmd => WRITE, addr => 16x"A1", data => 8x"21" ),
        (cmd => WRITE, addr => 16x"A2", data => 8x"22" ),
        (cmd => WRITE, addr => 16x"A3", data => 8x"23" ),
        (cmd => READ,  addr => 16x"10", data => 8x"10" ),
        (cmd => READ,  addr => 16x"11", data => 8x"11" ),
        (cmd => READ,  addr => 16x"12", data => 8x"12" ),
        (cmd => READ,  addr => 16x"13", data => 8x"13" ),
        (cmd => READ,  addr => 16x"20", data => 8x"20" ),
        (cmd => READ,  addr => 16x"21", data => 8x"21" ),
        (cmd => READ,  addr => 16x"22", data => 8x"22" ),
        (cmd => READ,  addr => 16x"23", data => 8x"23" )
    );
