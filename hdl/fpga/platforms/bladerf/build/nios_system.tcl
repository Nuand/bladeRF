...
if { [info exists nios_impl] == 0 } {
    ...
    switch -regexp $nios_impl {
        ...
        "[Ss][Mm][Aa][Ll][Ll]" { puts "using small"; set nios_impl Small  }
...
add_connection nios2.data_master lms_spi.avalon_slave_0
set_connection_parameter_value nios2.data_master/lms_spi.avalon_slave_0 arbitrationPriority {1}
set_connection_parameter_value nios2.data_master/lms_spi.avalon_slave_0 baseAddress {0x9200}
set_connection_parameter_value nios2.data_master/lms_spi.avalon_slave_0 defaultConnection {0}
...
add_connection system_clock.clk lms_spi.clock_sink
...
add_connection system_clock.clk_reset lms_spi.reset_sink
