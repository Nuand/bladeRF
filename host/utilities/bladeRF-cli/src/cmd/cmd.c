...
static const struct cmd cmd_table[] = {
    {
        ...
        FIELD_INIT(.help,
            ...
            "\tlms [show]\n"
            "\tlms tuning [value]\n"
            "\tlms txlpf [<I filter> <Q filter>]\n"
            "\tlms rxlpf [<I filter> <Q filter>]\n"
            "\tlms rxvga2 [<DC ref> <stage 1 I> <stage 1 Q> <stage 2 I> <stage 2 Q>\n"
            "\n"
            "\tPerform the specicified auto-calibration, or all of them if none\n"
            ...
            "\n"
            "RX and TX I/Q correction parameter calibration:\n"
            "\t<rx|tx> [<I> <Q>]\n"
            "\t<rxtx>\n"
            "\n"
            "\tCalibrate the DC offset correction paremeters for the current\n"
            ...
            "\tby 'cal tx'.\n"
            "\n"
            "Generate RX or TX I/Q correction parameter tables:\n"
            "\ttable <rx|tx> <output file> [ <f_min> <f_max> [f_inc] ]\n"
            "\n"
            "\tGenerate and write an I/Q correction paremeter table to the\n"
            "\tspecified file. 'f_min' and 'f_max' are min and max frequencies\n"
            "\tto include in the table. 'f_inc' is the frequency increment.\n"
