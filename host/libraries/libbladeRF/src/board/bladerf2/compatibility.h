#ifndef __COMPATIBILITY2_H__
#define __COMPATIBILITY2_H__
 ...
 */
int bladerf2_version_check_fw(const struct bladerf_version *fw_version,
...
int bladerf2_version_check(const struct bladerf_version *fw_version,
